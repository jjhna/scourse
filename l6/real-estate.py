...
# the main is just for safety, to ensure that it will work only inside this script
if __name__ == "__main__":
    ...
    data = spark.read.option("header", "true").option("inferSchema", "true")\
        .csv("file:///scourse/realestate.csv")
    ...
    # Now create our decision tree, one of the most powerful ML algorithms out there atm
